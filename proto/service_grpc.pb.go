...
const (
	...
	Greeter_CreateCosmetic_FullMethodName = "/helloworld.Greeter/createCosmetic"
...
func (c *greeterClient) CreateCosmetic(ctx context.Context, in *CreateCosmeticRequest, opts ...grpc.CallOption) (*CreateCosmeticResponse, error) {
	...
	err := c.cc.Invoke(ctx, Greeter_CreateCosmetic_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) ListCosmetics(ctx context.Context, in *ListCosmeticsRequest, opts ...grpc.CallOption) (*ListCosmeticsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Greeter_ListCosmetics_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_CreateCosmetic_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Greeter_CreateCosmetic_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Greeter_ListCosmetics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Greeter_ListCosmetics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
